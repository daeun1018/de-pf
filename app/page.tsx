...
export default function Home() {
  ...
  <nav className="ml-auto flex gap-4 sm:gap-6">
    <a href="#" className="text-sm font-medium hover:underline underline-offset-4">홈</a>
    <a href="#작업물" className="text-sm font-medium hover:underline underline-offset-4">작업물</a>
    <a href="#프로젝트" className="text-sm font-medium hover:underline underline-offset-4">프로젝트</a>
    <a href="#연락처" className="text-sm font-medium hover:underline underline-offset-4">연락처</a>
  </nav>
</header>
...
<footer className="flex flex-col sm:flex-row items-center gap-2 py-6 px-4 md:px-6 border-t bg-black text-white">
  <p className="text-xs">© 2024. 6. 27 김다은</p>
  <nav className="flex sm:ml-auto gap-4 sm:gap-6">
    <a className="text-xs hover:underline underline-offset-4" href="#">맨 위로</a>
  </nav>
</footer>
